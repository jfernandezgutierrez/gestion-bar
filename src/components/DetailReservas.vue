  ...
  export default {
    ...
    methods: {
      ...
      isFechaDisponible(fechaEntrada, fechaSalida) {
        // Excluir la reserva que estamos editando de la comparación
        return !this.reservas.some(reserva => {
          ...
          return (entrada >= reservaEntrada && entrada <= reservaSalida) || (salida >= reservaEntrada && salida <= reservaSalida);
        });
      },
